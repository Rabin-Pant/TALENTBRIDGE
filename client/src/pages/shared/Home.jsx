...
import {
  ...
  ChevronDown, ChevronUp, UserPlus, Globe
} from "lucide-react";
    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 mb-1">
      ...
      {!open && (
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex-1 text-left px-4 py-2.5 border border-gray-200 rounded-full text-sm text-gray-400 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
          >
      ...
      {open && (
        <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="text-xs text-gray-500 border border-gray-200 rounded-lg px-2 py-0.5 mt-0.5 focus:outline-none focus:ring-1 focus:ring-blue-500 bg-gray-50"
                >
                  {POST_TYPES.map((t) => (
          ...
          <textarea
            ...
            className="w-full text-sm text-gray-800 placeholder-gray-400 resize-none focus:outline-none border-0 p-0"
          />
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100">
            <button
              ...
              className="flex items-center gap-2 text-sm text-gray-500 hover:text-blue-600 px-3 py-1.5 rounded-lg hover:bg-blue-50 transition-all duration-200"
            >
              <Image size={17} /> Photo
            </button>
            ...
            <button
              ...
              className="flex items-center gap-2 bg-blue-600 text-white px-5 py-1.5 rounded-full text-sm font-medium hover:bg-blue-700 disabled:opacity-40 transition-all duration-200"
            >
              <Send size={13} />
      ...
      {!open && (
        <div className="flex items-center gap-1 mt-3 pt-3 border-t border-gray-100">
          <button
            onClick={() => { setOpen(true); setType("ACHIEVEMENT"); }}
            className="flex-1 flex items-center justify-center gap-2 py-1.5 rounded-lg text-xs font-medium text-amber-600 hover:bg-amber-50 transition-colors"
          >
            <Award size={15} /> Achievement
          </button>
          <button
            onClick={() => { setOpen(true); setType("JOB_UPDATE"); }}
            className="flex-1 flex items-center justify-center gap-2 py-1.5 rounded-lg text-xs font-medium text-emerald-600 hover:bg-emerald-50 transition-colors"
          >
            <Briefcase size={15} /> Job Update
          </button>
          <button
            onClick={() => { fileRef.current?.click(); setOpen(true); }}
            className="flex-1 flex items-center justify-center gap-2 py-1.5 rounded-lg text-xs font-medium text-blue-600 hover:bg-blue-50 transition-colors"
          >
            <Image size={15} /> Photo
          </button>
        </div>
  ...
  return (
    <div className="space-y-3">
          ...
          <div className="space-y-2 max-h-52 overflow-y-auto pr-1">
            {comments.map((c) => (
              <div key={c.id} className="flex items-start gap-2">
                <Avatar name={c.author?.fullName} role={c.author?.role} size="xs" />
      ...
      <div className="flex items-center gap-2">
        <Avatar name={user?.fullName} role={user?.role} size="xs" />
        <div className="flex-1 flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-full px-3 py-1.5 focus-within:border-blue-300 focus-within:bg-white transition-all">
          ...
          {text.trim() && (
            <button
              ...
              disabled={loading}
              className="text-blue-600 disabled:opacity-40 hover:text-blue-700 transition-colors"
            >
              <Send size={14} />
            </button>
          )}
...
const PostCard = ({ post, onDelete, user }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5 leading-none">
              {post.author?.currentTitle || post.author?.companyName || post.author?.role?.toLowerCase()}
            </p>
      ...
      {post.image && (
        <div
          className="cursor-zoom-in overflow-hidden border-y border-gray-100"
      ...
      <div className="flex items-center border-t border-gray-100 px-2 py-1">
        ...
        >
          <Heart size={17} className={liked ? "fill-blue-600" : ""} />
          Like
        </button>
        <button
          onClick={() => setShowComments(!showComments)}
          className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-700 transition-colors"
        >
  ...
  <div className="flex items-center gap-3 py-2.5 border-b border-gray-100 last:border-0">
    ...
    <div className="flex-1 min-w-0">
      ...
      <p className="text-xs text-gray-500 truncate">
        {u.currentTitle || u.companyName || u.role?.toLowerCase()}
      </p>
    </div>
    <button
      onClick={() => onConnect(u.id)}
      className="flex items-center gap-1 px-3 py-1 border border-gray-300 text-gray-700 rounded-full text-xs font-medium hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200 flex-shrink-0"
    >
            ...
            <div className="lg:col-span-2 space-y-3">
              ...
              {posts.length === 0 ? (
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-12 text-center">
                  ...
                  <Link
                    to="/network"
                    className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-full text-sm font-medium hover:bg-blue-700 transition-colors"
                  >
                ...
                <>
                  ...
                  {hasMore && (
                    <button
                      ...
                      className="w-full py-3 bg-white border border-gray-200 rounded-2xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors disabled:opacity-50"
                    >
                      {loadingMore ? (
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="px-4 pb-4">
                  ...
                  <Link
                    ...
                    className="font-semibold text-gray-900 hover:underline block text-sm"
                  >
                    {user?.fullName}
                  </Link>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100">
                    <Link
                      to="/network"
                      className="flex items-center justify-between text-xs text-gray-500 hover:text-blue-600 transition-colors py-1"
                    >
                      <span>Connections</span>
                      <span className="font-semibold text-blue-600">Grow →</span>
                    </Link>
                    <Link
                      to="/messages"
                      className="flex items-center justify-between text-xs text-gray-500 hover:text-blue-600 transition-colors py-1"
              ...
              {suggestions.length > 0 && (
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Link to="/network" className="text-xs text-blue-600 hover:underline font-medium">
                      See all
                    </Link>
                  </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4">
                ...
                <div className="space-y-1">
                  {user?.role === "SEEKER" ? (
                    <>
                      <Link to="/seeker/jobs" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-600 py-1.5 px-2 rounded-lg hover:bg-blue-50 transition-all duration-150">
                        <Briefcase size={15} className="text-gray-400" /> Browse Jobs
                      </Link>
                      <Link to="/seeker/applications" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-600 py-1.5 px-2 rounded-lg hover:bg-blue-50 transition-all duration-150">
                        <FileText size={15} className="text-gray-400" /> My Applications
                      </Link>
                      <Link to="/seeker/notifications" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-600 py-1.5 px-2 rounded-lg hover:bg-blue-50 transition-all duration-150">
                        <Sparkles size={15} className="text-gray-400" /> Notifications
                      </Link>
                    </>
                  ) : (
                    <>
                      <Link to="/employer/jobs/post" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-600 py-1.5 px-2 rounded-lg hover:bg-blue-50 transition-all duration-150">
                        <Briefcase size={15} className="text-gray-400" /> Post a Job
                      </Link>
                      <Link to="/employer/applicants" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-600 py-1.5 px-2 rounded-lg hover:bg-blue-50 transition-all duration-150">
                        <Users size={15} className="text-gray-400" /> View Applicants
                      </Link>
                      <Link to="/employer/notifications" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-blue-600 py-1.5 px-2 rounded-lg hover:bg-blue-50 transition-all duration-150">
                        <Sparkles size={15} className="text-gray-400" /> Notifications
                      </Link>
                    </>
                  )}
