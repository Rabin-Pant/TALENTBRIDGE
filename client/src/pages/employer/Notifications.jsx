...
import { Bell, Users, Settings, Sparkles } from "lucide-react";
import Navbar from "../../components/Navbar";
import Sidebar from "../../components/Sidebar";
import api from "../../api/axios";

const TYPE_ICON = {
  APPLICATION:   { icon: Users,    bg: "bg-green-100",  color: "text-green-600"  },
  STATUS_UPDATE: { icon: Bell,     bg: "bg-blue-100",   color: "text-blue-600"   },
            ...
            <div className="space-y-3">
              {notifications.map((n, i) => {
                ...
                return (
                  <div
                    key={n.id}
                    className={`bg-white rounded-2xl border shadow-sm p-4 flex items-start gap-4 hover:-translate-y-0.5 hover:shadow-md transition-all duration-300 ${
                      !n.read ? "border-green-100" : "border-gray-100"
                    }`}
